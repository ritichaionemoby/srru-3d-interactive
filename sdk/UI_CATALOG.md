...
`World Counter` และ `World GUI` ไม่ใช่ปุ่มและไม่รับ interaction ทั้งคู่คงตำแหน่ง/มิติอยู่ในโลกจริง โดย Counter รับเฉพาะจำนวน ส่วน World GUI รับข้อความหลายบรรทัด
